...
class InsertDatabase extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tipo_quadros')->insert(['tipo' => 'F','descricao' => 'Férias', 'imagem'=>'img/tiposquadros/ferias.png']);
        DB::table('tipo_quadros')->insert(['tipo' => 'H','descricao' => 'Hábito', 'imagem'=>'img/tiposquadros/habito.png']);
        DB::table('tipo_quadros')->insert(['tipo' => 'M','descricao' => 'Mesada', 'imagem'=>'img/tiposquadros/mesada.png']);
        DB::table('tipo_quadros')->insert(['tipo' => 'T','descricao' => 'Tarefa', 'imagem'=>'img/tiposquadros/tarefa.png']);
