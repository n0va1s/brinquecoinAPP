...
/* harmony import */ var _board__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./board */ "./resources/js/board.js");
...
$(function () {
  ...
  $('img.emoji').on('click', function (event) {
    event.preventDefault(); //Change emojis

    var img = this.src.split('/')[5];
    var emojis = ['0.png', '1.png', '2.png'];

    var emoji = function emoji(img, emojis) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbrinquecoin"] = self["webpackChunkbrinquecoin"] || [];
