...
function criarCartaoQuadro() {
  ...
  divIcone.className = 'mdl-cell mdl-cell--1-col mdl-cell--4-col-tablet mdl-cell--1-col-phone';
  ...
  divIdade.className = 'mdl-cell mdl-cell--6-col mdl-cell--4-col-tablet mdl-cell--1-col-phone';
