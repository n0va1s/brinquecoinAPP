            ...
            <tbody>
              @foreach($registros as $registro)
                <tr>
                  ...
                  <td>
                    <a class="btn red darken-2" href="{{ route('admin.configuracao.tiposquadros.editar',$registro->id) }}">Editar</a>
                    <a class="btn cyan darken-2" href="{{ route('admin.configuracao.tiposquadros.deletar',$registro->id) }}">Deletar</a>
                  </td>
                </tr>
              @endforeach
            </tbody>
